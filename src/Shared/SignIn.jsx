        ...
        <div className="font-[sans-serif] text-[#333] bg-white md:h-screen p-4">
            ...
            <div className="grid grid-cols-2 justify-center items-center gap-8">
                <div className="  w-full  md:rounded-tr-xl md:rounded-br-xl lg:p-12 grid grid-cols-1 justify-center items-center gap-6 p-8">
                    ...
                    <img src={signIn} className="  w-full h-full object-contain block mx-auto" alt="login-image" />

                </div>
                <form className="max-w-md w-full mx-auto">
                    <div className="mb-12">
                        <h3 className=" text-primary text-center text-4xl font-extrabold">Sign In</h3>
                        <p className='m-3 text-primary text-center'>welcome back to orion trading </p>
                    </div>
                    <div className='bg-bg2 p-8 rounded'>
                    <div className=''>
                        <div className="relative flex items-center">
                            <input name="email" type="text" required className="w-full text-sm border-b border-gray-300 bg-bg2 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" />
                    ...
                    <div className="mt-12 grid justify-center">
                        ...
                        <p className="text-sm text-center mt-8">Don't have an account <a href="javascript:void(0);" className="text-primary font-semibold hover:underline ml-1 whitespace-nowrap">join Us</a></p>
                    </div>
                    </div>
